...
class File(Document):
	...
	def validate_duplicate_entry(self):
		if not self.flags.ignore_duplicate_entry_error and not self.is_folder:
			...
			print('file.py 168 ', self.content_hash)
			filters = {
	...
	def save_file(self, content=None, decode=False, ignore_existing_file_check=True):
		print('\n file.py 429', ignore_existing_file_check)
		file_exists = False
		...
		if duplicate_file:
			print('file.py 457 file duplicate')
...
def make_home_folder():
	print('file.py 541 make_home_dolder')
	home = frappe.get_doc({
		"doctype": "File",
		"is_folder": 1,
		"is_home_folder": 1,
