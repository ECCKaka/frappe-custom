...
def make_form_dict(request):
	...
	if 'application/json' in (request.content_type or '') and request_data:
		# print('\napp 133 ', request_data)
		# print('\n app 134', json.dumps(request_data))
		
		try:
			args = json.loads(request_data)
		except:
			from urllib.parse import unquote_plus
			print('\n need to change format of json. app 140  ',unquote_plus(request_data))
			args = json.loads(unquote_plus(request_data)) 
