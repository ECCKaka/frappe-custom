...
frappe.Application = Class.extend({
	...
	startup: function() {
		...
		this.set_app_logo_url()
			.then(() => {
				// console.log(new frappe.ui.toolbar.Toolbar());
				// console.log('hhh\n\n\n');
				this.make_nav_bar();
			});
		this.set_favicon();
		...
		// page container
		// firstly, it makes the container. then call frappe.route() to create the main page. 
		this.make_page_container();

		// route to home page
		// this is where pageview.js is getting called inside frappe.route()
		frappe.route();
